...
const helpInfo: HelpInfo = [
  ...
  {
    action: "Get calendar for a specific month",
    url: "/calendar",
    params: [
      {
        param: "year",
        meaning: "The year for which to generate the calendar (e.g., 2024)",
      },
      {
        param: "month",
        meaning: "The month number (1-12) for which to generate the calendar",
      },
      {
        param: "calendar",
        meaning: "The type of calendar to use (Gregorian or Lunar)",
      },
    ],
  },
];
